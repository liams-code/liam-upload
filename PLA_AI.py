...
predict_price("KRW-PLA")
schedule.every().hour.do(lambda: predict_price("KRW-PLA"))

# 로그인
upbit = pyupbit.Upbit(access, secret)
print("autotrade start")

# 자동매매 시작 , pla 5000원 이상으로 바꿈 , seconds을 hours=1로 바꿔서 8시에 매도하게 함.break,13/3,0.3.
while True:
    try:
